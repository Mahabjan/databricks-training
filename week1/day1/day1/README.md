...
##  Introduction
This repository includes a well-organized set of 65 SQL queries designed to help build a strong understanding of database concepts.
The queries are based on a simple schema involving  Employee, Department, and Project tables
